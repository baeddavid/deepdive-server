...
#TODO look into instance 
def get_upload_path(instance, filename):
    # If instance id doesnt exist create a new UUID
    if not instance.id:
        instance.id = uuid4()
    return f"{instance.id}/{instance.timestamp}/{filename}"
...
# DeepdiveUser is tied to Session class
