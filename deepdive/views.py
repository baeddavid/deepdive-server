...
class DatabaseViewSet(viewsets.ModelViewSet):
    # Allow unauthenicated users to hit this route
    ...
    def get_queryset(self):
        # Remove tying DeepDiveUser to Database view 
        return Database.objects.order_by("-timestamp")
    ...
    def create(self, request, *args, **kwargs):
        ...
        # This is passing database argumnets user: as the current user
        # What are implications of deleting this?
...
class PreviewTables(views.APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        db_file = DatabaseFile(file=file)
        db_file.save()
...
class UpdateDatabaseFileView(views.APIView):
    # Allow unauthenticated users to this route
    permission_classes = [AllowAny]
...
class SessionViewSet(viewsets.ModelViewSet):
    ...
    # Return all sessions to the user 
    def get_queryset(self):
    ...
    # This method also uses the DeepDiveUser object
    def perform_create(self, serializer):
        ...
        serializer.save(
            name=f"{database.name} session", tables=tables
        )
...
class UpdateVisualization(views.APIView):
    # Allow unauthenicated users to his this route
    permission_classes = [AllowAny]
...
class ExportVisualizationView(generics.RetrieveAPIView):
    # Allow unauthenticated users to hit this route
    permission_classes = [AllowAny]
